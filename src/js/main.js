...
if (tabBar !== null) {
    tabBar.style.width =
        document.querySelector(".tabs a.active").offsetWidth + "px";
}
...
document.querySelectorAll(".examples__select").forEach((btn) => {
...
if (document.querySelector(".constructor") !== null) {
    ...
    document
        .querySelector(".sidebar__trigger")
...
if (document.querySelector(".skills__dropdown") !== null) {
    ...
    document
        .querySelector(".skills__search input")
        .addEventListener("click", () => {
...
if (
    document.querySelector(".change") !== null &&
    document.querySelector(".change__right") !== null
) {
    document.querySelector(".change__right").style.height =
        document.querySelector(".change .container").offsetHeight + "px";
...
let progress = () => {
    document
        .querySelector(".reviews .slider__progress")
...
if (
    document.querySelector(".template__item") !== null &&
    window.outerWidth < 768
) {
    let items = document.querySelectorAll(".template__item");
...
if (document.querySelector(".topbar__edit") !== null) {
    let features = document.querySelector(".features");
    let change = document.querySelector(".change.preview .change__left");

    document.querySelector(".topbar__edit").addEventListener("click", () => {
        if (features.classList.contains("active")) {
            features.classList.remove("active");
